...
export function S3upload(){
    ...
    // S3 정보 설정
    const ACCESS_KEY = 'AKIA6GF3UGEMKBLVXS7T';
    const SECRET_ACCESS_KEY = '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';
          ...
          <div>
            ...
            <Row>
              <Col>
                ...
                {selectedFile?(
                  <Button color="primary" onClick={() => uploadBtnClicked(selectedFile)}> Upload to S3</Button>
                ) : null }
              </Col>
            </Row>
          </div>
